...
python "%~dp0correlations.py" ^
    --inpfile "..\Data\R123456.mdd" ^
    --pattern_mask "DV_US_IncomeNet,DV_US_EthnicityNet,DV_US_Region,ParentStatus,DV_FinalAgeGender,WGT_Device,BlueprintingLoop[{AmazonRelay}].BrandSupportAttPerfo, BlueprintingLoop[{Truckstop}].BrandSupportAttPerfo" ^
    ...
    --outfile "R123456_USAdult_correlations.xlsx"
